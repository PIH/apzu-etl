...
create temporary table temp_own_an_animal_drawn_cart as select encounter_id, value_coded from temp_teen_club_obs where concept = 'Own an animal-drawn Cart';
...
create temporary table temp_answer_for_teen_club_activities as select encounter_id, value_text from temp_teen_club_obs where concept = 'Answer for Teen Club Activities';
...
create temporary table temp_answer_for_teens_club_purpose as select encounter_id, value_text from temp_teen_club_obs where concept = 'Answer for Teens Club Purpose';
...
create temporary table temp_answer_for_teen_club_topics as select encounter_id, value_text from temp_teen_club_obs where concept = 'Answer for Teen Club Topics';
...
create temporary table temp_are_people_afraid_to_be_around_you as select encounter_id, value_coded from temp_teen_club_obs where concept = 'Are people afraid to be around you?';
...
create temporary table temp_subjects_or_areas_study_interest_most as select encounter_id, value_coded from temp_teen_club_obs where concept = 'What subjects or areas of study interest you the most?';
...
create temporary table temp_own_a_bicycle as select encounter_id, value_coded from temp_teen_club_obs where concept = 'Own a bicycle';
...
create temporary table temp_healthy_looking_person_hiv_infection as select encounter_id, value_coded from temp_teen_club_obs where concept = 'Can a healthy-looking person have HIV infection?';
...
create temporary table temp_can_an_hiv_infected_person_live_longer as select encounter_id, value_coded from temp_teen_club_obs where concept = 'Can an HIV infected person live longer?';
...
create temporary table temp_can_hiv_aids_be_cured as select encounter_id, value_coded from temp_teen_club_obs where concept = 'Can HIV/AIDS be cured?';
...
create temporary table temp_own_an_car_truck as select encounter_id, value_coded from temp_teen_club_obs where concept = 'Own an car/truck';
...
create temporary table temp_career_job_finish_school as select encounter_id, value_text from temp_teen_club_obs where concept = 'What career/job would you like to do when you finish school?';
...
create temporary table temp_careers_or_indust_curious_or_learn_more as select encounter_id, value_coded from temp_teen_club_obs where concept = 'Are there any specific careers or industries that you are curious about or would like to learn more about?';
...
create temporary table temp_challenges_you_face_in_daily_life as select encounter_id, value_text from temp_teen_club_obs where concept = 'Challenges you face in daily life';
...
create temporary table temp_fuel_for_household_cooking as select encounter_id, value_coded from temp_teen_club_obs where concept = 'Fuel for household cooking';
...
create temporary table temp_current_school_class as select encounter_id, value_text from temp_teen_club_obs where concept = 'Current School class';
...
create temporary table temp_what_you_don as select encounter_id, value_text from temp_teen_club_obs where concept = 'What you don';
...
create temporary table temp_dropped_out_school_class as select encounter_id, value_text from temp_teen_club_obs where concept = 'Dropped out School Class';
...
create temporary table temp_enrolled_in_teen_club as select encounter_id, value_coded from temp_teen_club_obs where concept = 'Enrolled in teen club';
...
create temporary table temp_have_you_ever_used_elicit_drugs as select encounter_id, value_coded from temp_teen_club_obs where concept = 'Have you ever used elicit drugs?';
...
create temporary table temp_extracurricular_activities as select encounter_id, value_text from temp_teen_club_obs where concept = 'Extracurricular activities';
...
create temporary table temp_own_a_refrigerator as select encounter_id, value_coded from temp_teen_club_obs where concept = 'Own a refrigerator';
...
create temporary table temp_gender_of_contact as select encounter_id, value_coded from temp_teen_club_obs where concept = 'Gender of contact';
...
create temporary table temp_vocat_training_or_certs_field as select encounter_id, value_coded from temp_teen_club_obs where concept = 'Have you obtained any vocational training or certifications in your desired field?';
...
create temporary table temp_are_you_happy_with_teen_club as select encounter_id, value_coded from temp_teen_club_obs where concept = 'Are you happy with teen club?';
...
create temporary table temp_role_models_or_profs_field_look as select encounter_id, value_coded from temp_teen_club_obs where concept = 'Are there any role models or professionals in your desired field that you look up to?';
...
create temporary table temp_did_sex_exchange_money_goods_or_favor as select encounter_id, value_coded from temp_teen_club_obs where concept = 'Did you have sex in exchange for money, goods or favor?';
...
create temporary table temp_do_you_have_sex_when_you as select encounter_id, value_coded from temp_teen_club_obs where concept = 'Do you have sex when you';
...
create temporary table temp_did_ever_sex_someone_younger_or as select encounter_id, value_coded from temp_teen_club_obs where concept = 'Did you ever have sex with someone who is younger or you';
...
create temporary table temp_started_thinking_future_career_and_job_aspir as select encounter_id, value_coded from temp_teen_club_obs where concept = 'Have you started thinking about your future career and job aspirations?';
...
create temporary table temp_health_facility_name as select encounter_id, value_text from temp_teen_club_obs where concept = 'Health facility name';
...
create temporary table temp_how_is_hiv_aids_prevented as select encounter_id, value_coded from temp_teen_club_obs where concept = 'How is HIV/AIDS prevented?';
...
create temporary table temp_answer_for_how_hiv_is_transmitted as select encounter_id, value_text from temp_teen_club_obs where concept = 'Answer for How HIV is transmitted';
...
create temporary table temp_are_you_in_school as select encounter_id, value_coded from temp_teen_club_obs where concept = 'Are you in school?';
...
create temporary table temp_have_you_ever_used_injectable_drugs as select encounter_id, value_coded from temp_teen_club_obs where concept = 'Have you ever used injectable drugs?';
...
create temporary table temp_data_collection_date as select encounter_id, value_date from temp_teen_club_obs where concept = 'Data collection date';
...
create temporary table temp_interviewer_name as select encounter_id, value_text from temp_teen_club_obs where concept = 'Interviewer Name';
...
create temporary table temp_extracurr_acts_or_clubs_career_intrsts as select encounter_id, value_coded from temp_teen_club_obs where concept = 'Are you currently involved in any extracurricular activities or clubs related to your career interests?';
...
create temporary table temp_is_hiv_a_punishment_for_bad_behaviour as select encounter_id, value_coded from temp_teen_club_obs where concept = 'Is HIV a punishment for bad behaviour?';
...
create temporary table temp_is_hiv_just_a_matter_of_bad_luck as select encounter_id, value_coded from temp_teen_club_obs where concept = 'Is HIV just a matter of bad luck?';
...
create temporary table temp_answer_for_kind_of_teen_club_support as select encounter_id, value_text from temp_teen_club_obs where concept = 'Answer for Kind of teen club support';
...
create temporary table temp_answer_kind_teen_club_supp_get as select encounter_id, value_text from temp_teen_club_obs where concept = 'Answer for Kind of teen club support would you like to get';
...
create temporary table temp_kind_toilet_facility_used_household_members as select encounter_id, value_coded from temp_teen_club_obs where concept = 'Kind of toilet facility used by household members';
...
create temporary table temp_what_you_like_most_at_teen_club as select encounter_id, value_text from temp_teen_club_obs where concept = 'What you like most at teen club?';
...
create temporary table temp_literate as select encounter_id, value_coded from temp_teen_club_obs where concept = 'Literate';
...
create temporary table temp_own_a_mobile_telephone as select encounter_id, value_coded from temp_teen_club_obs where concept = 'Own a mobile telephone';
...
create temporary table temp_own_a_motorcycle as select encounter_id, value_coded from temp_teen_club_obs where concept = 'Own a motorcycle';
...
create temporary table temp_total_number_of_household_members as select encounter_id, value_numeric from temp_teen_club_obs where concept = 'Total number of household members';
...
create temporary table temp_parents_location as select encounter_id, value_text from temp_teen_club_obs where concept = 'Parents location';
...
create temporary table temp_plans_after_school as select encounter_id, value_coded from temp_teen_club_obs where concept = 'Plans after school';
...
create temporary table temp_primary_guardian as select encounter_id, value_coded from temp_teen_club_obs where concept = 'Primary Guardian';
...
create temporary table temp_own_a_radio as select encounter_id, value_coded from temp_teen_club_obs where concept = 'Own a radio';
...
create temporary table temp_rate_chgs_hppnd_life_social_supp_scale_1_3 as select encounter_id, value_coded from temp_teen_club_obs where concept = 'Can you rate the changes that happened to your life from the social support a scale of 1 to 3?';
...
create temporary table temp_rate_supp_scale_1_3 as select encounter_id, value_coded from temp_teen_club_obs where concept = 'How do you rate the support on a scale of 1 to 3?';
...
create temporary table temp_rate_your_hiv_knowledge as select encounter_id, value_coded from temp_teen_club_obs where concept = 'Rate your HIV knowledge';
...
create temporary table temp_reason_for_staying_with_single_parent as select encounter_id, value_coded from temp_teen_club_obs where concept = 'Reason for staying with single parent';
...
create temporary table temp_name_of_role_model_s as select encounter_id, value_text from temp_teen_club_obs where concept = 'Name of role model(s)';
...
create temporary table temp_social_support_from_teen_club as select encounter_id, value_coded from temp_teen_club_obs where concept = 'Social support from teen club';
...
create temporary table temp_main_source_of_drinking_water_for_household as select encounter_id, value_coded from temp_teen_club_obs where concept = 'Main source of drinking water for household';
...
create temporary table temp_main_energy_source_for_household_lighting as select encounter_id, value_coded from temp_teen_club_obs where concept = 'Main energy source for household lighting';
...
create temporary table temp_own_a_tv as select encounter_id, value_coded from temp_teen_club_obs where concept = 'Own a Tv';
...
create temporary table temp_do_you_have_a_toilet_at_home as select encounter_id, value_coded from temp_teen_club_obs where concept = 'Do you have a toilet at home?';
...
create temporary table temp_type_of_house_floor as select encounter_id, value_coded from temp_teen_club_obs where concept = 'Type of house floor';
...
create temporary table temp_type_of_house_roof as select encounter_id, value_coded from temp_teen_club_obs where concept = 'Type of house roof';
...
create temporary table temp_village as select encounter_id, value_text from temp_teen_club_obs where concept = 'Village';
...
create temporary table temp_what_courses_or_what_do_you_want_to_do_life as select encounter_id, value_text from temp_teen_club_obs where concept = 'What courses or what do you want to do life?';
...
create temporary table temp_what_exactly_do_you_want_to_do_in_this_life as select encounter_id, value_text from temp_teen_club_obs where concept = 'What exactly do you want to do in this life?';
