...
select
    ...
    max(sv.ckd_stage) as ckd_stage,
    max(sv.confusion) as confusion,
    max(sv.conjunctiva) as conjunctiva,
    max(sv.creatinine) as creatinine,
    max(sv.diet_recommendations) as diet_recommendations,
