...
select
    ...
    max(sv.family_history_diabetes_mellitus) as family_history_diabetes_mellitus,
    max(sv.family_history_hypertension) as family_history_hypertension,
    ...
    max(sv.tb_status_year) as tb_status_year,
