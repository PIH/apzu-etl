...
select
    ...
    e.location,
    sv.colposcopy_of_cervix_with_acetic_acid,
    sv.sample_taken_for_viral_load,
    sv.adherence_counselling,
    sv.adherence_session_number,
    sv.age,
    sv.appointment_date,
    sv.clinical_impression_comments,
    sv.date_of_blood_sample,
    sv.date_of_returned_result,
    sv.date_result_to_guardian,
    sv.diastolic_blood_pressure,
    sv.height,
    sv.hiv_test_time_period,
    sv.hiv_test_type,
    sv.hiv_test_type,
    sv.lab_id,
    sv.lab_location,
    sv.lab_test_serial_number,
    sv.less_than_limit,
    sv.lower_than_detection_limit,
    sv.medication_adherence_percent,
    sv.muac,
    sv.name_of_support_provider,
    sv.number_of_missed_medication_doses_in_past_week,
    sv.outcome,
    sv.is_patient_preg,
    sv.pulse,
    sv.qualitative_time,
    sv.reason_for_no_result,
    sv.reason_for_no_sample,
    sv.reason_for_no_sample,
    sv.reason_for_testing,
    sv.reason_for_testing,
    sv.reason_to_stop_care,
    sv.refer_to_screening_station,
    sv.result_of_hiv_test,
    sv.result_of_hiv_test,
    sv.viral_load_sample_id,
    sv.symptom_absent,
    sv.symptom_present,
    sv.systolic_blood_pressure,
    sv.transfer_out_to,
    sv.units_of_age_of_child,
    sv.viral_load_counseling,
    sv.weight
