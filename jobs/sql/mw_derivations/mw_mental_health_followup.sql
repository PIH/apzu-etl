...
select
    ...
    max(sv.able_to_do_daily_activities) as able_to_do_daily_activities,
    ...
    max(sv.current_use_alcohol) as current_use_alcohol,
    ...
    max(sv.mse_depressed_mood) as mse_depressed_mood,
    max(sv.mse_disorganized_speech) as mse_disorganized_speech,
    max(sv.mse_disruptive_behaviour) as mse_disruptive_behaviour,
    max(sv.mse_elevated_mood) as mse_elevated_mood,
    max(sv.mse_lack_of_insight) as mse_lack_of_insight,
    max(sv.mse_delusions) as mse_delusions,
    max(sv.mse_hallucinations) as mse_hallucinations,
    max(sv.mse_other) as mse_other,
    ...
    max(sv.on_family_planning) as on_family_planning,
    max(sv.phq_nine_score) as phq_nine_score,
    max(sv.patient_stable) as patient_stable,
    ...
    max(sv.suicide_risk) as suicide_risk,
    ...
    max(sv.counselling_provided) as counselling_provided,
    ...
    max(sv.medications_side_effects) as medications_side_effects,
