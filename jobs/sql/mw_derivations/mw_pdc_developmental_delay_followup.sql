...
create temporary table temp_anticonvulsant as select encounter_id, value_coded from temp_pdc_dev_delay_obs where concept = 'Anticonvulsant';
...
create temporary table temp_continue_followup as select encounter_id, value_coded from temp_pdc_dev_delay_obs where concept = 'Continue followup';
...
create temporary table temp_adjust_dose as select encounter_id, value_coded from temp_pdc_dev_delay_obs where concept = 'Adjust dose';
...
create temporary table temp_medications_dispensed as select encounter_id, value_text from temp_pdc_dev_delay_obs where concept = 'Medications dispensed';
...
create temporary table temp_cup_feeding as select encounter_id, value_coded from temp_pdc_dev_delay_obs where concept = 'Cup-feeding';
...
create temporary table temp_breast_feeding as select encounter_id, value_coded from temp_pdc_dev_delay_obs where concept = 'Breast feeding';
...
create temporary table temp_orogastric_tube as select encounter_id, value_coded from temp_pdc_dev_delay_obs where concept = 'Orogastric tube';
...
create temporary table temp_food_supplement as select encounter_id, value_coded from temp_pdc_dev_delay_obs where concept = 'Food supplement';
...
create temporary table temp_height_cm as select encounter_id, value_numeric from temp_pdc_dev_delay_obs where concept = 'Height (cm)';
...
create temporary table temp_referred_out as select encounter_id, value_coded from temp_pdc_dev_delay_obs where concept = 'Referred out';
...
create temporary table temp_other_non_coded_text as select encounter_id, value_text from temp_pdc_dev_delay_obs where concept = 'Other non-coded (text)';
...
create temporary table temp_middle_upper_arm_circumference_cm as select encounter_id, value_numeric from temp_pdc_dev_delay_obs where concept = 'Middle upper arm circumference (cm)';
...
create temporary table temp_malawi_developmental_assessment_tool_summary as select encounter_id, value_coded from temp_pdc_dev_delay_obs where concept = 'Malawi Developmental Assessment Tool Summary (Normal)-(Coded)';
...
create temporary table temp_wasting_malnutrition as select encounter_id, value_coded from temp_pdc_dev_delay_obs where concept = 'Wasting/malnutrition';
...
create temporary table temp_appointment_date as select encounter_id, value_date from temp_pdc_dev_delay_obs where concept = 'Appointment date';
...
create temporary table temp_play_therapy as select encounter_id, value_coded from temp_pdc_dev_delay_obs where concept = 'Play therapy';
...
create temporary table temp_poor_growth as select encounter_id, value_coded from temp_pdc_dev_delay_obs where concept = 'Poor Growth';
...
create temporary table temp_signs_of_cerebral_palsy as select encounter_id, value_coded from temp_pdc_dev_delay_obs where concept = 'Signs of Cerebral Palsy';
...
create temporary table temp_hyper as select encounter_id, value_coded from temp_pdc_dev_delay_obs where concept = 'Hyper';
alter table temp_hyper add index temp_hyper_encounter_idx (encounter_id);

drop temporary table if exists temp_hypo;
create temporary table temp_hypo as select encounter_id, value_coded from temp_pdc_dev_delay_obs where concept = 'Hypo';
alter table temp_hypo add index temp_hypo_encounter_idx (encounter_id);

drop temporary table if exists temp_normal_generic;
create temporary table temp_normal_generic as select encounter_id, value_coded from temp_pdc_dev_delay_obs where concept = 'Normal(Generic)';
...
create temporary table temp_mental_health_referral as select encounter_id, value_coded from temp_pdc_dev_delay_obs where concept = 'Mental health referral';
...
create temporary table temp_weight_kg as select encounter_id, value_numeric from temp_pdc_dev_delay_obs where concept = 'Weight (kg)';
...
create temporary table temp_numeric_value_or_result as select encounter_id, value_numeric from temp_pdc_dev_delay_obs where concept = 'Numeric value or result';
