...
insert into mw_nutrition_pdc_initial (patient_id, visit_date, location, enrollment_reason_martenal_death, enrollment_reason_malnutrition, enrollment_reason_other, enrollment_reason_poser_support)
select
    e.patient_id,
